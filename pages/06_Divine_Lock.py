...
try:
    ...
    # CORRECCIÓN AQUÍ: Cambiado a unsafe_allow_html
    st.markdown(f"""
        <div style="background-color:#1e1e1e; padding:20px; border-left: 10px solid #00FF00; border-radius:10px;">
            <h2 style="margin:0;">Estado Moral: {state}</h2>
        </div>
